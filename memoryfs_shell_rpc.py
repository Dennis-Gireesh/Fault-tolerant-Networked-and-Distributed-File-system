...
class FSShell():
  ...
  #implements the repair of the server
  def repair(self,server_id):
      RawBlocks.repair(server_id)
    ...
    while (True):
      ...
      if len(splitcmd) == 0:
        ...
        if len(splitcmd) != 2:
          ...
          self.FileObject.RawBlocks.CheckAndInvalidate()
          self.cat(splitcmd[1])
          #elf.FileObject.RawBlocks.Release()
...
if __name__ == "__main__":
  ...
  ap.add_argument('-port0', '--port0', type=int, help='an integer value', required = False)
  ap.add_argument('-port1', '--port1', type=int, help='an integer value', required = False)
  ap.add_argument('-port2', '--port2', type=int, help='an integer value', required = False)
  ap.add_argument('-port3', '--port3', type=int, help='an integer value', required = False)
  ap.add_argument('-port4', '--port4', type=int, help='an integer value', required = False)
  ap.add_argument('-port5', '--port5', type=int, help='an integer value', required = False)
  ap.add_argument('-port6', '--port6', type=int, help='an integer value', required = False)
  ap.add_argument('-port7', '--port7', type=int, help='an integer value', required = False)
